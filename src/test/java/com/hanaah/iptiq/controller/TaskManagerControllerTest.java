...
public class TaskManagerControllerTest {
    ...
    public void When_killingProcessesByPriority_Then_allProcessesOfPriorityAreKilled()
        ...
        Assertions.assertEquals(0, taskManager.listRunningProcess().stream()
            .filter(process -> process.getPriority().equals(Priority.MEDIUM)).count());
        Assertions.assertEquals(1, taskManager.listRunningProcess().size());
    }
    ...
    public void When_killingAllProcesses_Then_allProcessesAreKilled()
        ...
        Assertions.assertTrue(taskManager.listRunningProcess().isEmpty());
    }
    ...
    public void When_listingProcessesByPriority_Then_correctOrderIsReturned()
        ...
        List<Priority> actual = response.stream().map(ProcessDto::getPriority)
            .collect(Collectors.toList());
        List<Priority> expected = actual.stream().sorted().collect(Collectors.toList());
